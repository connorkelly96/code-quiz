var questions = [
    ...
    {
        question: "What Does i Stand For in a For Loop",
        answers: [
...

    {
        ...
        answers: [
            { text: "var fruit = (0:'apple', 1:'pear', 2:'kiwi')", correct: false },
            { text: "var fruit = ['apple', 'pear', 'kiwi']", correct: true },
            { text: "var fruit = (apple, pear, kiwi)", correct: false },
